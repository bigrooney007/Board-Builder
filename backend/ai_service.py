...
GENERATION_TYPES = {
    ...
    }, "note": "You are consolidating participating Board Members' own recommitment responses into a shareable Board Reactivation / Engagement Plan. STRICT PRIVACY: NEVER include difficult-conversation guides, the founder's private assessments, private conversation conclusions, confidential information about another member, or anything a member did not themselves share. NEVER invent commitments. NEVER mention AI."},
    ...
    "reactivation_conversation_script": {"module": 3, "title": "Difficult Conversation Script", "per_application": True, "schema": {
        ...
        "what_you_need_to_understand": ["string — 3 to 5 specific things the founder needs clarity about in THIS conversation, each grounded in the member's actual answers (e.g. whether they can realistically commit their stated hours, whether they will own a specific area they expressed interest in, what role clarity they said is missing)"],
        ...
        "understand_their_experience": [{"question": "string — tailored question exploring their actual stated experience/barriers/clarity", "why_this_matters": "string", "listen_for": "string", "optional_follow_up": "string — may be empty"}],
        "explain_what_the_organization_needs_now": ["string — 3 to 5 concise founder talking points based ONLY on the organization's actual mission, direction, priorities and Board needs, ending with suggested language explaining the Board must now help carry specific responsibility"],
        "discuss_where_they_can_contribute": [{"question": "string — specific question connecting their verified expertise/interests/willingness to the organization's needs", "why_this_matters": "string"}],
        "move_from_interest_to_responsibility": ["string — 3 to 5 person-specific questions moving from vague willingness to explicit ownership: what they will own, what they can realistically commit to, what result can reasonably be expected, what support they need, how founder and member stay accountable"],
