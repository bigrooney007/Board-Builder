...
NEVER mention AI."""},
    "strategic_delegation_meeting_guide": {"module": 0, "title": "Strategic Planning Review & Delegation Meeting Facilitation Guide", "per_application": False, "schema": {
        "sections": "list of objects {heading: string, content: string} for the FIRST Board review and delegation meeting: (1) Meeting Objective, (2) Before the Meeting, (3) Open the Meeting, (4) Review the First Strategic Plan Draft area by area and record what stays, changes or is removed, (5) Resolve disagreements and identify decisions still needed, (6) Delegate every strategic area to the Board Member or team best aligned to lead deeper planning, (7) Explain the Detailed Plan assignment and approval process, (8) Confirm owners, collaborators, deadlines and next steps, (9) Close the Meeting. Use ONLY supplied plan content and do not pretend detailed area plans already exist.",
    }, "note": "This is the Board's first review/delegation meeting, BEFORE detailed area plans are built. Do not write an adoption meeting guide and do not claim Area Owners have submitted detailed plans. Help the facilitator review the first draft, improve it, delegate every area, and launch deeper planning. NEVER invent bylaws, quorum, voting requirements, facts or plan content. NEVER mention AI."},
