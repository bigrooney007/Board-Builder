...
DEFAULT_CONTENT = {
    ...
    "system_heading": "To Raise Money Exponentially, You Need A Fundraising System.",
    "system_subheading": "A System That Runs Consistently To Find, Attract, And Bring In Funding For Your Nonprofit Organization.",
    "strategy_heading": "To Build A Fundraising System, You Need A Fundraising Strategy.",
    "strategy_paragraphs": [
        "A clear strategy that identifies the exact type of people, businesses and grantors with the strongest reason to fund your mission, where to find them, how to attract them consistently, and the exact process to raise money from them.",
        "The Board Fundraising Game helps you build your organization's fundraising strategy with your board and anyone else you want involved in raising money and building your organization's fundraising system with you.",
        "When your board and others within your organization help build the strategy, they understand exactly how your organization plans to raise money. They contribute their own ideas. They become more likely to participate because they helped build the strategy with you. And they can work with you to build and manage the fundraising system needed to execute that strategy at the scale required to raise money exponentially and sustainably.",
        "With the Board Fundraising Game, you and everyone on your board and in your organization can learn how fundraising really works and leave your next board meeting with a clear fundraising direction for your organization, with a board that's ready to work with you to raise money and build your organization's fundraising system. Each board member leaves knowing exactly how they can participate, with their own Board Fundraising Portfolio and the execution materials they need to get started.",
    ],
