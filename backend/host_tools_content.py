        ...
        "sections": [
            {
                "key": "opening",
                "heading": "Opening",
                "body": "Hi [Board Member First Name], I wanted to speak with you briefly about something we are doing at our next board meeting.\n\n[Organisation Name] is working toward a fundraising goal of [Fundraising Goal] by [Fundraising Deadline], and instead of bringing in one person to create the fundraising strategy for us, we are going to build it together as a board.",
            },
            {
                "key": "explain_game",
        ...
        "sections": [
            {
                ...
                "blocks": [
                    {"kind": "list", "items": [
                        ...
                        "Make sure the Board-Prioritised Strategy can be generated after the Review Game",
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {"kind": "numbered", "label": "The Rounds", "items": [
                        ...
                        "What Should Our Execution Timeline Prioritise?",
                    ]},
                    ...
                    {"kind": "script", "label": "Host Language After Each Result", "text": "These are the ideas the board collectively prioritised. The other ideas are still being saved, so we are not losing anything."},
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {"kind": "numbered", "label": "Host Steps", "items": [
                        ...
                        "Wait for the Board-Prioritised Draft to finish generating before continuing.",
                    ]},
                ],
            },
            {
                ...
                "blocks": [
                    {"kind": "script", "label": "Host Script", "text": "We now have a complete fundraising strategy built from the information about our organisation and the priorities we selected together.\n\nWe are going to review it one section at a time.\n\nAs we review, I want everyone to think about whether the strategy accurately reflects what we believe the organisation should do.\n\nYou will be able to approve each section, suggest a change or identify something we need to discuss further."},
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {"kind": "script", "label": "Question 1", "text": "Does this accurately reflect what we believe the organisation should do?"},
                    ...
                    {"kind": "note", "label": "Facilitation Rule", "text": "Do not rewrite sections simply because one person prefers different wording. Focus discussion on strategic decisions that materially change what the organisation will do."},
            ...
            },
            {
                ...
                "blocks": [
                    {"kind": "script", "label": "Host Script", "text": "If there are no further changes that prevent us from moving forward, we now need to decide whether we are ready to adopt this as our organisation's fundraising strategy."},
                    {"kind": "text", "text": "Once adopted, this becomes the working fundraising strategy we will execute toward our [Fundraising Goal] goal.\n\nThe organisation should follow its normal board decision-making process."},
        ...
        "groups": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    "Confirm that the organisation's Fundraising Game Profile is accurate",
                ],
            },
            {
                "key": "before_meeting",
            ...
            },
            {
                ...
                "items": [
                    ...
                    "Generate the Board-Prioritised Strategy",
                    ...
                    "Complete the organisation's normal adoption process",
