...
class SupportedCheckoutRequest(BaseModel):
    origin_url: str = Field(min_length=1)
    product: str = Field(min_length=1)
    result_token: str = ""


SUPPORTED_SERVICE_OFFERS = {
    "recruitment": {
        "env_key": "STRIPE_RECRUITMENT_SUPPORTED_2997_PRICE_ID", "lookup_key": "recruitment_supported_2997",
        "name": "Board Recruitment With Rooney", "amount": 299700, "source": "recruitment_supported_2997",
    },
    "board-recommitment": {
        "env_key": "STRIPE_RECOMMITMENT_SUPPORTED_2497_PRICE_ID", "lookup_key": "board_recommitment_supported_2497",
        "name": "Board Recommitment With Rooney", "amount": 249700, "source": "board_recommitment_supported_2497",
    },
    "board-fundraising-game": {
        "env_key": "STRIPE_FUNDRAISING_GAME_SUPPORTED_2997_PRICE_ID", "lookup_key": "board_fundraising_game_supported_2997",
        "name": "Board Fundraising Game With Rooney", "amount": 299700, "source": "board_fundraising_game_supported_2997",
    },
    "strategic-planning": {
        "env_key": "STRIPE_STRATEGIC_PLANNING_SUPPORTED_2997_PRICE_ID", "lookup_key": "strategic_planning_supported_2997",
        "name": "Strategic Planning With Rooney", "amount": 299700, "source": "strategic_planning_supported_2997",
    },
}
...
def create_payment_router(db) -> APIRouter:
    ...
    async def flow_status(session_id: str, flow: str):
        contracts = {
            "recruitment": {"offer_sources": {"recruitment", "recruitment_supported_2997"}, "purchase_sources": {"recruitment_497", "recruitment_self_guided_497", "recruitment_supported_2997"}},
            "board-fundraising-game": {"offer_sources": {"board_fundraising_game", "board_fundraising_game_supported_2997"}, "purchase_sources": {"board_fundraising_game_497", "board_fundraising_game_supported_2997"}},
            "strategic-planning": {"offer_sources": {"strategic_planning", "strategic_planning_supported_2997"}, "purchase_sources": {"strategic_planning_497", "strategic_planning_supported_2997"}},
            "board-recommitment": {"offer_sources": {"board_recommitment", "board_recommitment_supported_2497"}, "purchase_sources": {"board_recommitment_497", "board_recommitment_supported_2497"}},
        }
    ...
    async def create_supported_checkout(payload: SupportedCheckoutRequest):
        ...
        await db.payment_transactions.insert_one({
            "session_id": session.id, **lead_context, "origin_url": payload.origin_url,
            "offer_source": meta["source"], "purchase_source": meta["source"], "selected_tier": "supported",
            "offer": meta["name"], "product": payload.product, "amount": meta["amount"], "currency": "usd",
            "status": "initiated", "payment_status": "pending", "supported_service": True,
            "test_mode": os.environ.get("STRIPE_MODE", "test") != "live", "created_at": now, "updated_at": now,
        })
        return {"checkout_url": session.url, "session_id": session.id}
