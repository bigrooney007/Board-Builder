...
const initialData = {
  ...
  present_fundraising_involvement: "", board_support_areas: [], written_fundraising_strategy: "", individual_responsibilities: "", board_participation_in_planning: "", missing_fundraising_elements: [], desired_result: "", support_required: "", execution_preference: "", additional_information: "", confirmation_accepted: false,
};
