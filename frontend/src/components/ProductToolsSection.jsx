...
export const ProductToolsSection = () => (
  <section id="tools-materials" className="tools-section" data-testid="product-tools-section">
    ...
    <div className="tools-list">
      ...
      <ToolFrame number={2} title="Apply to Join Our Board" caption="Attract serious applicants and collect the information required to determine who can genuinely strengthen your board.">
      ...
      <ToolFrame number={3} title="Board Fundraising Planning Form" caption="Activate every board member around the fundraising activities that fit their strengths, experience and relationships.">
      ...
      <ToolFrame number={4} title="Board Recommitment and Planning Form" caption="Give present board members a clear opportunity to recommit, accept meaningful responsibility or step down respectfully.">
