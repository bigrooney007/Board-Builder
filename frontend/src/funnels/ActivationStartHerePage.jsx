...
import { SITE_CONTENT, activationStartHerePageText } from "@/content/siteContent";
    ...
    <MemberShell>
      <main className="sh-page" data-testid="activation-start-here-page">
        <section className="funnel-hero-banner brp-hero sh-hero" data-testid="activation-start-here-hero">
          ...
          <p className="funnel-hero-banner-supporting" data-testid="activation-start-here-subtitle">{activationStartHerePageText.youAreAboutToTake}</p>
          <i aria-hidden="true" />
        </section>

        <section className="sh-blocks" data-testid="activation-start-here-copy">
          <article className="sh-block">
            <p>{activationStartHerePageText.doNotSimplyTellYour}</p>
            <p>{activationStartHerePageText.buildThePlanWithThem}</p>
            <p><strong>{activationStartHerePageText.peopleWhoPlanTogetherExecute}</strong></p>
          </article>
        </section>
