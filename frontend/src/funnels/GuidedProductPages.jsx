...
export const GUIDED_PRODUCT_CONFIG={
  "strategic-planning":{
    ...
    steps:[
      ...
      ["3","Review The Ideas Together In One Live Session","Move through Mission, Goals, Objectives, each Program and every major strategic area one screen at a time. The Board discusses and selects the ideas that should shape the plan."],
      ["4","Agree How The Plan Will Be Carried Forward","During Action Planning, discuss what happens next and say clearly who will lead or support each agreed responsibility."],
      ["5","Generate And Approve The Strategic Plan","The platform turns the Board-selected ideas and meeting conclusions into one professional Strategic Plan. The organization leader reviews, edits and approves it."],
      ["6","Send Each Person Their Role And Execution Support","Confirm the responsibilities agreed in the meeting, then send each delegated person the approved plan, their Board Leadership Portfolio and their Executive Assistant."],
    ],
    outcomes:["A professional Board-built Strategic Plan","Every participant's original ideas preserved and traceable","One live Board session instead of multiple builder and adoption meetings","Human-confirmed delegation based on what was actually agreed","A personal Board Leadership Portfolio and Executive Assistant for each delegated leader"],
    intakeFields:[
      ["mission","What is your organization's mission? Who do you serve, how do you serve them, and what change are you trying to create?","textarea"],
      ["goals","What are your present goals for the next 12–24 months? What are you trying to achieve?","textarea"],
      ["objectives","What objectives are you presently pursuing to achieve those goals? What results is each objective meant to produce?","textarea"],
      ["programs","List each current program or service on its own line so the Board can review every program separately.","textarea"],
      ["team_building","Who do you presently have available to support the organization? Include staff, Board Members, volunteers, contractors or other people who help deliver the work.","textarea"],
      ["operations","What systems or processes presently keep the organization running? Where do you already see operational problems, bottlenecks or gaps?","textarea"],
      ["marketing","How do people presently hear about the organization? Who are you trying to reach, and what are you presently doing for marketing, visibility or communications?","textarea"],
      ["partnerships","What partnerships or important relationships do you presently have? What kinds of partners do you believe the organization needs?","textarea"],
      ["fundraising","How are you presently raising money? What has worked, what has not worked, and what do you believe needs to improve?","textarea"],
      ["technology","What technology or tools do you presently use? What work do you need technology to make easier, faster or more reliable?","textarea"],
      ["budget","What is your present budget or best current understanding of what it costs to operate and grow the organization? Include only numbers you actually know.","textarea"],
      ["action_planning","What important actions are already planned or underway? What do you believe needs to happen next?","textarea"],
    ],
  },
  "board-recommitment":{
