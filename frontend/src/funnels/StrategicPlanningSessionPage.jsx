...
export default function StrategicPlanningSessionPage(){
 ...
 return <BfgShell><main className="guided-page sp-live-session"><section className="sp-session-screen">
  ...
  <div className="sp-facilitator-prompt"><strong>Discuss this with the Board.</strong><p>Review the ideas shared before the meeting. Let people explain what they mean, then click every idea the Board agrees should shape this section.</p></div>
  ...
  {section.is_action_planning&&<div className="sp-action-planning-callout"><h2>Agree Who Will Help Carry The Plan Forward</h2><p>Discuss what happens first, next and after that. Then say each person's name and the exact responsibility they are agreeing to lead or support. Include people who did not complete the original form if they take a role. Their email can be added afterward.</p></div>}
