...
export default function FacilitatedGameApplicationPage() {
  ...
  return <BfgShell><main className="facilitated-page" data-testid="facilitated-application-page">
    <section className="facilitated-hero">
      ...
      <p>Tell me a little about your organization and your board. Once you submit the application, we will review it and be in touch through email.</p>
    </section>
    <section className="facilitated-section">
      ...
      {submitted ? <>
        ...
        <p>We have received your application and will be in touch through email.</p>
        ...
        <small>No payment is required to apply. We will review your application and contact you through email.</small>
      </form>}
      </div>
    </section>
  </main></BfgShell>;
