...
const ONBOARDING_TOOLS = [
  ["onboarding_agenda", "Onboarding Agenda", "Generate My Onboarding Agenda"],
  ["organization_overview", "Organization Overview", "Generate My Organization Overview"],
  ["board_manual", "Board Manual", "Generate My Board Manual"],
  ["board_member_agreement", "Board Member Agreement", "Generate My Board Member Agreement", true],
  ["confidentiality_agreement", "Confidentiality Agreement", "Generate My Confidentiality Agreement", true],
  ["conflict_of_interest_agreement", "Conflict of Interest Agreement", "Generate My Conflict of Interest Agreement", true],
  ["ninety_day_plan", "New Board Member 90-Day Plan", "Generate My New Board Member 90-Day Plan"],
];
...
const OnboardingApplicant = ({ application }) => {
  ...
  return (
    <div className="onboarding-applicant" data-testid={`onboarding-${application.application_id}`}>
      ...
      {ONBOARDING_TOOLS.map(([type, title, buttonLabel, isAgreement]) => (
        <div key={type}>
          <MaterialCard type={type} title={title} buttonLabel={buttonLabel} applicationId={application.application_id} material={byType[type]} refresh={refresh} />
