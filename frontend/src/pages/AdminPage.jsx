  ...
  return (
    <section data-testid="admin-reference-library">
      ...
      <div className="admin-filters reference-upload-row">
        ...
        <input placeholder="Resource tags (comma separated, optional)" value={form.resource_types} onChange={(event) => setForm({ ...form, resource_types: event.target.value })} data-testid="reference-tags-input" />
