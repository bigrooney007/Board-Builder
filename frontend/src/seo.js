...
export const PAGE_META = {
  ...
  aboutRooney: ["Rooney Akpesiri | The Nonprofit Board Builder", "Meet Rooney Akpesiri, The Nonprofit Board Builder, and choose how you would like help recruiting the board your nonprofit needs."],
  recruitYourBoardYourself: ["Recruit Your Board Yourself | Nonprofit Board Builder", "Watch Rooney run the board recruitment process, follow what he does for your own nonprofit, use the execution materials provided and reach out for support whenever you need help."],
  boardRecruitmentIntake: ["Tell Me About Your Organization and Board | Nonprofit Board Builder", "Give Rooney the information he needs to start your board recruitment."],
