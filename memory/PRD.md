...
- 2026-06: FINAL MASTER PRODUCT CORRECTION AND SYSTEM UPGRADE (95-point spec, single push, NO TESTING per user rule):
  ...
  - **Unlock + Facilitated offers**: /game/unlock (UnlockGamePage, $497 via /payments/game-checkout); /organize-board-fundraising-game (FacilitatedGamePage, $3,497 via /payments/facilitated-game-checkout, unit_amount 349700, success → /board-activation-intake?facilitated=1 which contains the Calendly booking step). facilitated_board_fundraising_game entitlement grantable from Contact Center.
