...
require(button, "PLAY AUDIO", "customer Play Audio control")
require(button, "PAUSE AUDIO", "customer Pause Audio control")
require(button, "AUDIO COMING SOON", "safe missing-audio state")
