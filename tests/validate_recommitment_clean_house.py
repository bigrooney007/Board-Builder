...
require(guided, '"session_id": payload.session_id', "indexed Recommitment session key during paid-flow initialization")
require(backend, 'f"recommitment-{member[\'user_id\']}"', "fallback indexed Recommitment session key")
...
require(understand, "VIEW FULL RESPONSE", "single full-response action")
require(understand, "DOWNLOAD FULL RESPONSE", "response download inside the response view")
require(understand, "INTERPRET RESPONSE", "response interpretation")
require(understand, "CREATE CALL SCRIPT", "initial individual conversation script action")
require(understand, "VIEW CALL SCRIPT", "existing conversation script action")
require(understand, "REGENERATE CALL SCRIPT", "secondary script regeneration inside the script view")
...
require(portfolio_workflow, "GENERATE BOARD PORTFOLIO", "explicit Board Portfolio generation")
require(portfolio_workflow, "VIEW / EDIT BOARD PORTFOLIO", "explicit Board Portfolio workspace")
require(portfolio_workflow, "PREPARE EMAIL TO SEND BOARD PORTFOLIO", "explicit Board Portfolio email action")
require(direct_invite, "Board Member Role", "Board Member role on personal invitation")
require(forms_section, "Email signature:", "visible recommitment email signature")
require(backend, "email_with_current_identity", "current sender and organization identity on saved outreach drafts")
